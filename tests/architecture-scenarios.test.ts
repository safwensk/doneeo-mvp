...
const IMPLEMENTED = new Set(["P1", "L1", "L2", "L6", "L7", "L12", "L09A", "L09B"]);
...
const COVERED = new Set([
  ...
  // L09B is built; its scenarios assert in tests/l09b-responsibility-fairness.test.ts
  "L09B-G1", "L09B-G2", "L09B-G3",
  // L6 is built; its scenarios assert in tests/l6-pricing-offer.test.ts
  "L6-G1", "L6-G2", "L6-G3",
  // L12 is built; its scenarios assert in tests/l12-settlement-ledger.test.ts
  "L12-G1", "L12-G2", "L12-G3",
]);
...
test("every recovered scenario is accounted for", () => {
  ...
  for (const layer of ["L6", "L7", "L12", "L09A", "L09B"]) {
